...
function EjercicioCard({ ejercicio }) {
  const grupos    = Array.isArray(ejercicio.grupo_muscular) ? ejercicio.grupo_muscular : [];
  const equipas   = Array.isArray(ejercicio.equipamiento)     ? ejercicio.equipamiento     : [];
    ...
    <div className="card">
      <div className="card-content">
        ...
        <div className="ejerciciosCarac">
          ...
          <p><strong>Grupo muscular:</strong> {grupos.join(", ")}</p>
          <p><strong>Equipamiento:</strong> {equipas.join(", ")}</p>
